...
export default function GlassMenuModal({ visible, onClose, onAction, isMuted, isBlocked, isGhost }) {
  ...
  const mainOptions = [
    { id: '1', label: 'Wyświetl kontakt', icon: VxProfileIcon, danger: false, actionKey: 'VIEW_CONTACT' },
    ...
    { id: '6', label: 'Więcej', icon: VxGearIcon, danger: false, action: () => setMenuView('MORE') },
  ];
